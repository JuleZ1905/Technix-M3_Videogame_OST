...
class Seeder
{
    ...
    public static function seed()
    {
        $videogames[] = new VideogameOST(1, "Super Mario Bros Theme", "Super Mario Bros", "2000", [
            ...
            new Track(4, "World 3", "Koji Kondo", 4, "1:33")
        ]);
        ...
        $videogames[] = new VideogameOST(3, "Far Cry 5 OST", "Far Cry 5", "2018", [
        ...
        $allOSTs = array('SuperMario'=>$videogames[0], 'Minecraft'=>$videogames[1], 'FarCry5'=>$videogames[2]);
